...
package inshow.carl.com.csd.view;
...
//        paint.setTypeface(mInputText.getTypeface());
        ...
        mLabelPaint.setColor(getResources().getColor(R.color.colorPrimary));
...
//        }
        ...
        for (int selectorIndex : selectorIndices) {
            ...
            if (posy < 1) {
                mSelectorWheelPaint.setColor(getAlphaGradient(posy, getResources().getColor(R.color.colorPrimary)/*TEXT_COLOR_FG*/, true));
                canvas.drawText(scrollSelectorValue, x, y + (sizeFg - TEXT_SIZE_MIN) / 2.0f, mSelectorWheelPaint);
            }
